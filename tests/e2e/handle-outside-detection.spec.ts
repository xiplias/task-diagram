...
test('handles should detect clicks even when cursor is outside visual radius', async ({ page }) => {
  ...
  await page.screenshot({ path: 'tests/e2e/handle-outside-detection-page.png' });
